...
package com.haiyunshan.net.margaritov.preference.colorpicker;
...
import com.haiyunshan.colorpicker.R;
...
public class ColorPickerView extends View {
     ...
     * color panels.
     */
    private float PANEL_SPACING = 18f;
    /**
    ...
    private void init() {
        ...
        this.mLeftArrow = getResources().getDrawable(R.drawable.ic_hue_left, null);
        this.mRightArrow = getResources().getDrawable(R.drawable.ic_hue_right, null);
    ...
    private void drawHuePanel(Canvas canvas) {
        ...
        {
            Drawable d = this.mLeftArrow;
            int width = d.getIntrinsicWidth();
            int height = d.getIntrinsicHeight();
            int right = (int)(rect.left - 1 * mDensity);
            int left = right - width;
            int top = p.y - height / 2;
        ...
        {
            Drawable d = this.mRightArrow;
            int width = d.getIntrinsicWidth();
            int height = d.getIntrinsicHeight();
            int left = (int)(rect.right + 1 * mDensity + 1);
...
//        canvas.drawRoundRect(r, 2, 2, mHueTrackerPaint);
    ...
    private boolean moveTrackersIfNeeded(MotionEvent event) {
        ...
        mTmpRect.set(mHueRect);
        mTmpRect.left -= PANEL_SPACING;
        mTmpRect.right += 2 * PANEL_SPACING;
        mTmpRect.top = 0;
        mTmpRect.bottom = this.getHeight();

        if (mTmpRect.contains(startX, startY)) {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        int offset = (this.getWidth() - this.mChooseWidth) / 2;
        mDrawingRect.left += offset;
        mDrawingRect.right -= offset;
