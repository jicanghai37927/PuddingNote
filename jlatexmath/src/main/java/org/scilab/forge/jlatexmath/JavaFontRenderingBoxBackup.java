 ...
 */
public class JavaFontRenderingBoxBackup extends Box {
	...
	public JavaFontRenderingBoxBackup(String str, int type, float size, Typeface f,
			boolean kerning) {
		this.str = str;
		this.size = size;
		/*
	...
	public JavaFontRenderingBoxBackup(String str, int type, float size) {
